...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "GA4 shared parameters for GA4 for javascript interface",
  "description": "This is the template for GTM Tag Template call GA4 for javascript interface made by Pluszero-global.\n\nYou can use this template to put the Shared Parameters blank the template I told upper.",
  "containerContexts": [
    "WEB"
  ]
}
